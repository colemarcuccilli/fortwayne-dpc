...
// plus the ROI one-pager. This is the REAL program:
//   Flat $79 per employee per month ($948/yr). No enrollment fees,
//   copays, deductibles, or surprise bills.
//   The pitch is access, then fewer avoidable costs (urgent care, ER,
...
export const EMPLOYER_ECONOMICS = {
  ...
  costPerUrgentCare: 200, // doc: $150 to $250+
  costPerErVisit: 2000, // doc: $1,500 to $3,000+ (conservative floor)
  costPerMissedWorkday: 300, // doc: 20 workdays approx $4,000 to $8,000
...
export const EMPLOYERS = {
  hero: {
    ...
    title: "Real healthcare for your team.",
    titleAccent: "For less than a missed workday a month.",
    subtitle:
      "Fort Wayne Direct Primary Care gives your employees unlimited, same-day access to their own physician, with no copays, no deductibles, and no insurance barriers, for a flat $79 per employee per month. Healthier employees, fewer avoidable costs, and a benefit they'll actually use.",
    primaryCta: { label: "See your ROI in 30 seconds", href: "#estimate" },
    secondaryCta: { label: "Book a 15 minute consult", href: "/contact" },
  },

  // The sales hook line from the doc (dashes removed).
    ...
    groups: [
      {
        ...
        items: [
          ...
          "Direct physician access by secure message, phone, and telehealth",
      ...
      },
      {
        ...
        items: [
          "Acute care for infections, minor injuries, skin, and allergies",
  ...
  roi: {
    ...
    hiddenCosts: [
      ...
      },
      {
        ...
        amount: "Days to weeks",
        detail: "Lost productivity, delayed treatment, and more urgent care visits.",
      },
    ],
    exampleNote:
      "Example. A 20-employee company invests $18,960 a year. Avoiding just 10 urgent-care visits, 2 ER visits, and 20 missed workdays, plus retaining a single employee, can offset much or all of that. Run your own numbers below.",
  },
  ...
  idealGroups: {
    ...
    subtitle: "Especially valuable for small and mid-sized employers with 5 to 250 people:",
    groups: [
      "Manufacturing",
      "Construction",
  ...
  // Employer FAQ, handles the common objections.
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Same-day or next-day in-office visits, plus direct access to Dr. Aluri by secure message, phone, and telehealth. Visits run 30 to 60 minutes, enough time to actually solve the problem.",
      },
      {
