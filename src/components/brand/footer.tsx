...
export function Footer({ brand, nav, tagline }: FooterProps) {
  return (
    <footer className="mt-24 border-t border-border/60 bg-surface-muted/50">
      ...
      <div className="border-t border-border/60">
        <div className="mx-auto flex w-full max-w-6xl flex-col items-start justify-between gap-2 px-5 py-6 sm:flex-row sm:items-center sm:px-8">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} {PRACTICE.physician.name}. All rights reserved.
          </p>
          <p className="text-xs text-muted-foreground">
            Medical information on this site is for educational purposes and is
